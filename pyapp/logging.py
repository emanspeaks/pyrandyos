...
def _log_exc_hook(exc_or_type: type | BaseException = None,
    ...
    # die instantly.  We have multiple mechanisms already in PyApp to try to
    # catch and log exceptions, but if one is showing up here, it somehow got
    # through the cracks since this is the handler of last resort.
    #
