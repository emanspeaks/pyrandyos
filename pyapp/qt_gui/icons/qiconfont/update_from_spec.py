...
from pyapp.utils.system import get_path_to_top_package_dir
from pyapp.qt_gui.icons.qiconfont.sources import THIRDPARTY_FONTSPEC
from pyapp.qt_gui.icons.qiconfont.fontspec import (
...
NAMES_PY = 'names.py'
PYAPP_DIR = get_path_to_top_package_dir('pyapp')
